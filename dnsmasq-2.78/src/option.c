...
#define LOPT_FILTER_AAAA_byzds   351
...
static const struct myoption opts[] = 
  ...
  { 
    ...
    { "filter-ipv6-byzds", 0, 0, LOPT_FILTER_AAAA_byzds },
...
static struct {
  ...
  { LOPT_FILTER_AAAA_byzds, OPT_FILTER_AAAA_byzds, NULL, gettext_noop("Filter ipv6 requests."), NULL },
